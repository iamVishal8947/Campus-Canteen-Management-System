...
public class ItemMasterController {
	...
	@PutMapping("/{itemId}")
	public ResponseEntity<?> updateDepartment(@PathVariable Long itemId,
	...
	public ResponseEntity<?> deleteEmployee(@PathVariable Long itemId) {
		System.out.println("in update item " + itemId);
